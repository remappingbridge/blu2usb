...
assert 'project(blu2usb_picow VERSION 0.6.1' in cmake
assert 'BLU2USB_VERSION_STRING="0.6.1"' in cmake
...
assert "blu2usb_ux_first_mouse_connected(ux)" in app
assert "blu2usb_ux_first_mouse_disconnected(ux)" in app
...
print("BLU2USB v0.6.1 first-start UX contract: OK")
